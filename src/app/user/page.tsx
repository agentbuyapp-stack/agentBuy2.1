  ...
  return (
    <div className="w-full h-screen flex justify-center pt-20 bg-gray-50">
      <div className="w-235 h-fit bg-white rounded-xl border shadow-amber-100 flex flex-col justify-center items-center px-4 gap-6 pt-6">
        ...
        />
        <button
          className="h-13 w-225 flex bg-linear-to-r from-[#0b4ce5] to-[#4a90e2] mb-5 rounded-xl text-white justify-center items-center cursor-pointer transition-transform duration-200 ease-out hover:scale-102 active:scale-95"
        ...
        <div className="fixed z-10 top-0 left-0 w-screen h-screen flex justify-center items-center bg-[rgba(0,0,0,0.2)] backdrop-blur-sm">
          <div className="w-125 h-155 bg-white rounded-xl border shadow-xl flex flex-col justify-center items-center gap-4 p-6">
            ...
            <div className="w-113 h-16 flex justify-end items-end">
              <button
                className="w-113 h-10 bg-linear-to-r from-[#0b4ce5] to-[#4a90e2] hover:from-[#0a42c7] hover:to-[#3d7ec7] rounded-lg flex justify-center items-center text-white text-[14px] font-semibold cursor-pointer transition-all duration-200 ease-out hover:scale-105 active:scale-95 shadow-md hover:shadow-lg"
        ...
        <div className="fixed z-10 top-0 left-0 w-screen h-screen flex justify-center items-center bg-black/40 backdrop-blur-sm">
          <div className="w-100 bg-white rounded-xl shadow-2xl border flex flex-col items-center justify-center gap-6 p-6 animate-in fade-in zoom-in duration-200">
            ...
            <div className="w-90 flex gap-3">
              ...
              <button className="flex-1 flex justify-center items-center h-11 rounded-lg bg-linear-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold cursor-pointer transition-all duration-200 ease-out hover:scale-105 active:scale-95 shadow-md hover:shadow-lg">
                Устгах
              </button>
            </div>
          </div>
      ...
      {succesOrder && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="relative w-125 bg-white rounded-2xl shadow-2xl p-10 flex flex-col items-center gap-6 animate-in fade-in zoom-in duration-300">
            ...
            <div className="text-center space-y-2">
              <h3 className="text-2xl font-bold text-gray-800">Амжилттай!</h3>
              <p className="text-gray-600">Таны захиалга амжилттай хийгдлээ</p>
            </div>
            <button
              onClick={() => setSuccesOrder(false)}
              className="w-full py-3 px-6 bg-linear-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
            >
              Үргэлжлүүлэх
            </button>
          </div>
