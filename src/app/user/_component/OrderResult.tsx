...
export const OrderResult = (props: Click) => {
    ...
    return (
        <div className="min-h-20 w-225 bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 flex justify-between px-6 py-4 items-center border border-gray-100 group hover:border-blue-200">
