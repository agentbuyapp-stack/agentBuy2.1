...
export const NewOrderBtn = (props: NewOrder) => {
  ...
  return (
    <>
      <div className="h-14 min-[640px]:h-24 w-full max-w-85 min-[640px]:max-w-4xl flex justify-between items-center bg-gradient-to-r from-white via-blue-50/50 to-white rounded-xl min-[640px]:rounded-2xl px-3 min-[640px]:px-6 border border-blue-100 shadow-sm">
        <div className="flex items-center gap-2 min-[640px]:gap-4">
          ...
          <div className="flex flex-col gap-0.5">
            <h2 className="text-sm min-[640px]:text-3xl font-bold text-gray-800">
              Шинэ захиалга үүсгэх
            </h2>
            <p className="text-[9px] min-[640px]:text-xs text-gray-500 flex items-center gap-1">
