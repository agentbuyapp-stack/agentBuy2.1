        ...
        <div className="w-full min-h-screen flex justify-center pt-10 min-[640px]:pt-20 px-3 min-[640px]:px-4 dark:bg-gray-900 dark:bg-gray-900 bg-gray-50">
            <div className="w-full max-w-90 min-[640px]:max-w-235 h-fit bg-white rounded-xl min-[640px]:rounded-2xl shadow-xl min-[640px]:shadow-2xl dark:bg-gray-800 dark:border-0 border border-gray-200 flex flex-col gap-4 min-[640px]:gap-6 p-4 min-[640px]:p-8">
                <div className="flex w-full bg-linear-to-r dark:bg-linear-to-r dark:from-gray-900 dark:to-gray-900  from-gray-100 to-gray-50 rounded-xl min-[640px]:rounded-2xl p-1 min-[640px]:p-1.5 gap-1 min-[640px]:gap-2 shadow-inner">
                    <button
                        className={`flex-1 flex items-center justify-center gap-1.5 min-[640px]:gap-3 rounded-lg min-[640px]:rounded-xl py-2 min-[640px]:py-3 px-2 min-[640px]:px-4 font-semibold transition-all duration-300 relative ${activeTab === "all"
                    ...
                    >
                        ...
                        <span className="text-xs min-[640px]:text-base dark:text-white">Бүх захиалга</span>
                        {allOrdersCount > 0 && (
                            <span
                                className={`absolute -top-1 -right-1 w-5 h-5 min-[640px]:w-6 min-[640px]:h-6 rounded-full flex items-center justify-center text-[10px] min-[640px]:text-xs font-bold ${activeTab === "all" ? "bg-yellow-400 text-blue-900" : "hidden"
                                    }`}
                            >
                                {allOrdersCount}
                            </span>
                    ...
                    <button
                        className={`flex-1 flex items-center justify-center gap-1.5 min-[640px]:gap-3 rounded-lg min-[640px]:rounded-xl py-2 min-[640px]:py-3 px-2 min-[640px]:px-4 font-semibold transition-all duration-300 relative ${activeTab === "completed"
                    ...
                    >
                        ...
                        <span className="text-xs min-[640px]:text-base dark:text-white">Амжилттай</span>
                        {completedOrdersCount > 0 && (
                            <span
                                className={`absolute -top-1 -right-1 w-5 h-5 min-[640px]:w-6 min-[640px]:h-6 rounded-full flex items-center justify-center text-[10px] min-[640px]:text-xs font-bold ${activeTab === "completed"
