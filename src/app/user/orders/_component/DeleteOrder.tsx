...
export const DeleteOrder = (props: Delete) => {
  ...
  return (
    <div className="fixed z-10 top-0 left-0 w-screen h-screen flex justify-center items-center bg-black/40 backdrop-blur-sm p-4">
      <div className="w-full max-w-[320px] min-[640px]:max-w-100 bg-white rounded-xl shadow-2xl border flex flex-col items-center justify-center gap-4 min-[640px]:gap-6 p-5 min-[640px]:p-6 animate-in fade-in zoom-in duration-200">
        ...
        <div className="w-full flex flex-col items-center text-center gap-1 min-[640px]:gap-2">
          <p className="text-[15px] min-[640px]:text-[17px] text-gray-500 font-medium">
            Захиалга #1
          </p>
          <p className="text-[17px] min-[640px]:text-[20px] font-bold text-gray-800">
            Та устгахдаа итгэлтэй байна уу?
          </p>
          <p className="text-xs min-[640px]:text-sm text-gray-500 mt-1">
            Энэ үйлдлийг буцаах боломжгүй
          </p>
        </div>
        <div className="w-full flex gap-2 min-[640px]:gap-3">
          <button
            className="flex-1 flex justify-center items-center h-10 min-[640px]:h-11 rounded-lg border-2 border-gray-300 bg-white hover:bg-gray-50 text-gray-700 text-sm min-[640px]:text-base font-semibold cursor-pointer transition-all duration-200 ease-out hover:scale-105 active:scale-95 shadow-sm"
