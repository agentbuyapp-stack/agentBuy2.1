    ...
    <>
      ...
      <div className="mb-4">
        ...
        <div className="bg-white border border-green-300 rounded-lg overflow-hidden">
          <div className="bg-linear-to-r from-blue-600 to-blue-700 p-2 flex items-center gap-2">
          ...
          <div className="p-3 space-y-3">
            ...
            <div>
              ...
              <div className="bg-linear-to-r from-green-500 to-emerald-500 rounded p-3 text-center">
      ...
      <div className="bg-linear-to-r from-blue-50 to-cyan-50 rounded-lg p-3 border border-blue-200">
        ...
        <ol className="space-y-1.5 text-xs text-gray-700">
          <li className="flex gap-2">
            <span className="w-5 h-5 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold text-xs shrink-0">
              1
            </span>
            <span>
          ...
          <li className="flex gap-2">
            ...
            <span>
              Гүйлгээний утгад <strong className="text-red-600">ORDER#1</strong>{" "}
              бичнэ үү
            </span>
          </li>
          <li className="flex gap-2">
