  ...
  return (
    <div className="w-full max-w-[320px] min-[640px]:max-w-110 bg-white dark:bg-gray-900 shadow-lg dark:shadow-gray-900/50 hover:shadow-xl dark:hover:shadow-gray-900/70 rounded-xl transition-all duration-300 p-3 min-[640px]:p-4 flex flex-col gap-2.5 min-[640px]:gap-3 border border-gray-100 dark:border-gray-600">
      ...
      <div className="grid grid-cols-3 gap-1.5 min-[640px]:gap-2 mt-auto">
        ...
        <button
          className="py-1.5 min-[640px]:py-2 bg-green-50 dark:bg-green-900/30 hover:bg-green-100 dark:hover:bg-green-900/50 text-green-500 dark:text-green-600 rounded-lg text-[10px] min-[640px]:text-xs font-semibold transition-all flex flex-col items-center gap-0.5 min-[640px]:gap-1 hover:scale-105"
