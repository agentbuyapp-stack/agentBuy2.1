...
export const PriceInf = (props: PriceInf) => {
  ...
  return (
    ...
    bg-white dark:bg-gray-900">
        <div className="bg-gradient-to-r from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 p-4 flex items-center justify-between">
        ...
        <div className="p-6 space-y-4">
          ...
          text-gray-700 dark:text-gray-200">
            ...
            border border-gray-300 hover:border-blue-500 focus:ring-2 focus:ring-green-500 focus:border-transparent
            bg-white text-gray-800 placeholder-gray-400
            dark:bg-gray-800 dark:border-gray-600 dark:hover:border-blue-400 dark:focus:ring-green-400
        ...
        border-gray-200 dark:border-gray-700">
            ...
            <button
              className="flex-1 py-2.5 rounded-lg font-semibold transition-all text-sm shadow-md disabled:opacity-50 disabled:cursor-not-allowed
