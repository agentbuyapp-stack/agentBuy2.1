      ...
      <div className="w-full max-w-2xl max-h-[90vh] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="flex-1 flex p-6 gap-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm text-gray-600 mb-4">Тайлбар</p>
          </div>
        </div>
        ...
        <div className="p-4 bg-gray-50 border-t border-gray-200 flex gap-2">
          ...
          <button
            className="flex-1 py-2.5 bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg font-semibold transition-all hover:scale-[1.02] shadow-md text-sm"
